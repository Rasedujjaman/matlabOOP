classdef CameraPhotonFocus < handle
    % CameraPhotonFocus 
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
     ...
     properties (Constant = true)
        ...
        CameraName   = 'Photon Focus';
        CameraModel  = 'AG_MV1-D1312-100-GB-12';
        CameraSerial = '022300009708';
        AdaptorVersion = 'gige';       % Do not change, required to identify the camera
        SensorWidth  = 1312; % Sensor size (maximum number of active pixel along the width)
        SensorHeight = 1082; % Sensor size (maximum number of active pixel along the height)
        PixelSize = 8.5;     % Square pixel of 8.5um x 8.5um 
    ...
    methods
        ...
        function obj = CameraPhotonFocus(pixel_format) 
